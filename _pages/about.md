...
- **DKiS**: Decay weight invertible image steganography with private key — *Neural Networks* (2025) · [GitHub](https://github.com/yanghangAI/DKiS)
- **PRIS**: Practical robust invertible network for image steganography — *Engineering Applications of Artificial Intelligence* (2024) · [GitHub](https://github.com/yanghangAI/PRIS)
- **CovidViT**: A novel neural network with self-attention mechanism to detect Covid-19 through X-ray images — *International Journal of Machine Learning and Cybernetics* (2023)

## Contact

- Email: [hangyang@umass.edu](mailto:hangyang@umass.edu)
- Google Scholar: [Hang Yang](https://scholar.google.com/citations?user=usu8YBAAAAAJ)
- GitHub: [yanghangAI](https://github.com/yanghangAI)
